...
const RateMaster = () => {
  const longServices = useSelector((state) => state.longService.longServices) || [];
  console.log(longServices);
  const shortServices = useSelector((state) => state.shortService.shortServices) || [];
  console.log(shortServices);
  const addOnServices = useSelector((state) => state.addOnService.addOnServices) || [];
    ...
    try {
      if (rateMasterData.serviceType === 'Long Service') {
        ...
        setBill({
          ...
          installableArea: data[0].installableArea * parseInt(rateMasterData.installableArea, 10),
          lightConnection: data[0].lightConnection * parseInt(rateMasterData.lightConnection, 10),
          total:
            data[0].installableArea * parseInt(rateMasterData.installableArea, 10) +
                ...
                <>
                  <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, mb: 2 }}>
                    <TextField
                      ...
                      value={rateMasterData.installableArea}
                      onChange={handleChange}
                    />
                    <TextField
            ...
            >
              ...
              >
                <Box sx={{ width: '100%' }}>
                  ...
                  <Box>
                    <Typography variant="body1" gutterBottom component="div">
                      ...
                      {rateMasterData.installableArea} Sqft
                    </Typography>
                  </Box>
                  <Box>
                    <Typography variant="body1" gutterBottom component="div">
                ...
                <Box sx={{ width: '100%' }}>
                  ...
                  <Box>
                    <Typography variant="body1" gutterBottom component="div">
                      <strong>Installation Price: </strong>₹{bill.installableArea}
                    </Typography>
                  </Box>
                  <Box>
                    <Typography variant="body1" gutterBottom component="div">
